...
namespace CatLib.Routing
{
    ...
    internal sealed class RouteOptions
    {
        ...
        /// <returns>当前路由配置实例</returns>
        public RouteOptions OnError(Action<IRequest, IResponse, System.Exception, Action<IRequest, IResponse, System.Exception>> onError, int priority = int.MaxValue)
        {
        ...
        public IFilterChain<IRequest, IResponse, System.Exception> GatherOnError()
        {
            return onError;
        }
